            ...
            $http.get('http://www.omdbapi.com/?t='+this.query).success(function(data){
                ...
                if(!data.Title){
                    ...
                    if(data.Director!="N/A"){
                        that.director = "<b>Director:</b> " + data.Director;
                    }else{
                        that.director= "No Director";
                    }
                    
                    if(data.Writer!="N/A"){
                        that.writer = "<b>Writer:</b> " + data.Writer;
                    }else{
                    ...
                    if(data.Actors!="N/A"){
                        that.actors = "<b>Stars:</b> " + data.Actors;
                    }else{
